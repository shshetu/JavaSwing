 ...
 * @author shshe
 */
public class DeleteCompanyView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Company Form");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteCompanyView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
