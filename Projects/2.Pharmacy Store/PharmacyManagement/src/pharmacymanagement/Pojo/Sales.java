...
public class Sales {
    ...
    public Sales(int productId, String productName, String productCode, String medicineGroup, InsertCompany company, ProductCategory productCategory, int productQuantity, double productPrice, Date expireDate, String doseType, String remarks) {
        this.productId = productId;
        this.productName = productName;
        this.productCode = productCode;
        this.medicineGroup = medicineGroup;
    ...
    public Sales(String productName, String productCode, String medicineGroup, InsertCompany company, ProductCategory productCategory, int productQuantity, double productPrice, Date expireDate, String doseType, String remarks) {
        this.productName = productName;
        this.productCode = productCode;
        this.medicineGroup = medicineGroup;
        this.company = company;
